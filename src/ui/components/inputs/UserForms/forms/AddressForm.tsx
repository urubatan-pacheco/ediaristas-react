...
import useAddressForm from 'data/hooks/components/inputs/UserForms/forms/useAddressForm';
import { Controller } from 'react-hook-form';
import { AddressData } from '../UserForms.style';
            ...
            <Controller
                ...
                render={({ field: { ref, ...inputProps } }) => (
                    <Autocomplete
                        ...
                        noOptionsText={'Nenhuma cidada com esse nome'}
                        renderInput={(params) => (
                            <TextField
                                label={'Cidade'}
                                {...params}
